...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<bool> *map_quark_jet_muon;
   vector<float> *primHadron_pdgId;
   vector<float> *primHadron_pt;
   vector<float> *primHadron_y;
   vector<float> *primHadron_phi;
   vector<float> *primHadron_m;
   vector<float> *ancQuark_pdgId;
   vector<float> *ancQuark_pt;
   vector<float> *ancQuark_y;
   vector<float> *ancQuark_phi;
   vector<float> *ancQuark_m;
   
   vector<float> *bFragmentation_function_pT;
   ...
   TBranch *b_map_quark_jet_muon;
   TBranch *b_primHadron_pdgId;
   TBranch *b_primHadron_pt;
   TBranch *b_primHadron_y;
   TBranch *b_primHadron_phi;
   TBranch *b_primHadron_m;
   TBranch *b_ancQuark_pdgId;
   TBranch *b_ancQuark_pt;
   TBranch *b_ancQuark_y;
   TBranch *b_ancQuark_phi;
   TBranch *b_ancQuark_m;

   TBranch  *b_bFragmentation_function_pT;
   TBranch  *b_bjet_pt;
   TBranch  *b_bjet_eta;
   TBranch  *b_bjet_phi;
   TBranch  *b_cjet_pt;
...
void tree_class::Init(TTree *tree,TString part)
{
   ...
   map_quark_jet_muon = nullptr;
   primHadron_pdgId = nullptr;
   primHadron_pt = nullptr;
   primHadron_y = nullptr;
   primHadron_phi = nullptr;
   primHadron_m = nullptr;
   ancQuark_pdgId = nullptr;
   ancQuark_pt = nullptr;
   ancQuark_y = nullptr;
   ancQuark_phi = nullptr;
   ancQuark_m = nullptr;

   bFragmentation_function_pT = nullptr;
   bjet_pt = nullptr;
   bjet_eta = nullptr;
   bjet_phi = nullptr;
   cjet_pt = nullptr;
...
//VB: For genJet analysis
   ...
   fChain->SetBranchAddress("map_quark_jet_muon",&map_quark_jet_muon,&b_map_quark_jet_muon);
   fChain->SetBranchAddress("primHadron_pdgId",&primHadron_pdgId,&b_primHadron_pdgId);
   fChain->SetBranchAddress("primHadron_pt",&primHadron_pt,&b_primHadron_pt);
   fChain->SetBranchAddress("primHadron_y",&primHadron_y,&b_primHadron_y);
   fChain->SetBranchAddress("primHadron_phi",&primHadron_phi,&b_primHadron_phi);
   fChain->SetBranchAddress("primHadron_m",&primHadron_m,&b_primHadron_m);
   fChain->SetBranchAddress("ancQuark_pdgId",&ancQuark_pdgId,&b_ancQuark_pdgId);
   fChain->SetBranchAddress("ancQuark_pt",&ancQuark_pt,&b_ancQuark_pt);
   fChain->SetBranchAddress("ancQuark_y",&ancQuark_y,&b_ancQuark_y);
   fChain->SetBranchAddress("ancQuark_phi",&ancQuark_phi,&b_ancQuark_phi);
   fChain->SetBranchAddress("ancQuark_m",&ancQuark_m,&b_ancQuark_m);
   ...
   fChain->SetBranchAddress("bFragmentation_function_pT",&bFragmentation_function_pT,&b_bFragmentation_function_pT);
